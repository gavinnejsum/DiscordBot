...
const borgReaction = require('./OfficerCategories/Borg/borgReaction');
const stellaCategory = require('./OfficerCategories/Stella/Stella.json');
const stellaReaction = require('./OfficerCategories/Stella/stellaReaction');
const armadaCategory = require('./OfficerCategories/Armadas/Armadas.json');
const armadaReaction = require('./OfficerCategories/Armadas/armadasReaction');
const swarmCategory = require('./OfficerCategories/Swarms/Swarms.json');
const swarmReaction = require('./OfficerCategories/Swarms/swarmsReaction');
const discoveryCatergory = require('./OfficerCategories/PVP/Discovery/Discovery.json')
const discoveryReactions = require('./OfficerCategories/PVP/Discovery/DiscoveryReactions')
const augurCategory =require('./OfficerCategories/PVP/Augur/Augur.json')
const augurReaction =require('./OfficerCategories/PVP/Augur/augurReaction')
...
function chooseType(Discord, message, command, args) {
  const formattedArgs = args.toString().toLowerCase();
  const embed = createEmbeddedMessages.officerTypeReaction(formattedArgs);

  if (embed !== null) {
    message.channel.send(embed).then((embedTypeMsg) => {
      // send reactions for each getOfficerCategories
      const getOfficerCategories = getOfficerCategory(formattedArgs.toString());
